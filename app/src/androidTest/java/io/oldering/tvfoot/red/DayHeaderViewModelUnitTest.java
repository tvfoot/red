...
@RunWith(AndroidJUnit4.class) public class DayHeaderViewModelUnitTest {
  ...
  @Test public void create_Aujourdhui() {
  ...
  @Test public void create_Demain() {
    String headerKey = simpleDateFormat.format(new Date(System.currentTimeMillis() + ONE_DAY));
    DayHeaderViewModel dayHeaderVM = DayHeaderViewModel.create(headerKey);
  ...
  @Test public void create_ApresDemain() {
