...
public class MatchViewModelUnitTest {
  ...
  //
  //        PowerMockito.mockStatic(MatchViewModel.class);
  //
  ...
  //
  //        whenNew(AutoValue_MatchViewModel.class).withAnyArguments().thenReturn(null);
  //
  //        when(MatchViewModel.create(match, rxBus)).thenCallRealMethod();
  //
  ////        PowerMockito.verifyStatic();
  //        MatchViewModel.create(match, rxBus);
  //        PowerMockito.verifyStatic();
  //        MatchViewModel.parseStartTime(date2);
  //        PowerMockito.verifyStatic();
  //        MatchViewModel.parseHeadLine(homeTeam, null, "yoyo");
  //    }
  //
  // @Test
  ...
  @Test public void parseStartTime() {
  ...
  @Test public void parseBroadcasters() {
  ...
  @Test public void parseBroadcasters_empty() {
    assertEquals(MatchViewModel.parseBroadcasters(null), new ArrayList<>());
  }

  @Test public void parseHeadline() {
    ...
    Team awayTeam =
        Team.create(notEmpty, awayTeamName, notEmpty, notEmpty, notEmpty, notEmpty, notEmpty,
            notEmpty, notEmpty);

    assertEquals(MatchViewModel.parseHeadLine(homeTeam, awayTeam, null),
        homeAwayName.toUpperCase() + " - " + awayTeamName.toUpperCase());
  }

  @Test public void parseHeadline_noteam() {
    ...
    assertEquals(MatchViewModel.parseHeadLine(homeTeam, awayTeam, matchLabel), matchLabel);
  }

  @Test public void parseCompetition() {
    String code = "code";
    String name = "name";
  ...
  @Test public void parseMatchDay() {
    String label = "label";
