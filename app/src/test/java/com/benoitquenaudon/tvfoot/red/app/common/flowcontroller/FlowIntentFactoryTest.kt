...
class FlowIntentFactoryTest {
  @Ignore("Robolectric and LeakCanary") @Test fun toMatches() {
  ...
  @Ignore("Robolectric and LeakCanary") @Test fun toMatch() {
  ...
  @Ignore("Robolectric and LeakCanary") @Test fun toSettings() {
