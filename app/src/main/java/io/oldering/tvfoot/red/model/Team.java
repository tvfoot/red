...
@AutoValue public abstract class Team {
  ...
  public static Team create(@Nullable String code, @Nullable String name, @Nullable String fullname,
      @Nullable String city, @Nullable String country, @Nullable String url,
      @Nullable String stadium, @Nullable String twitter, @Nullable String type) {
  ...
  @Nullable public abstract String getCity();

  @Nullable public abstract String getCountry();

  @Nullable public abstract String getUrl();

  @Nullable public abstract String getStadium();

  @Nullable public abstract String getTwitter();
