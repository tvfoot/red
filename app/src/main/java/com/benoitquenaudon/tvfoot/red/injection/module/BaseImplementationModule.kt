...
import com.benoitquenaudon.tvfoot.red.app.data.source.TeamRepository
import dagger.Binds
...
abstract class BaseImplementationModule {
  ...
  @Binds
  abstract fun provideTeamRepository(teamRepository: TeamRepository): BaseTeamRepository
