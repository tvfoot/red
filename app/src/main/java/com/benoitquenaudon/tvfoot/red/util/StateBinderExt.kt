...
fun RedViewModel<*, *>.logIntent(intent: MviIntent) {
...
fun RedViewModel<*, *>.logAction(action: MviAction) {
...
fun RedViewModel<*, *>.logResult(result: MviResult) {
...
fun RedViewModel<*, *>.logState(state: MviViewState) {
